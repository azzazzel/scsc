package demo.scsc.external.warehouse;
...
public class ExternalWarehouse {
    ...
    private void loadInventory() {
        ...
        InputStream jsonInput = ExternalWarehouse.class.getClassLoader().getResourceAsStream("products.json");
        try {
